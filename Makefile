#Makefile
all:ALU_test.out MUX_test.out SignExtension_test.out ControlUnit_test.out DecodeUnit_test.out Forwarding_test.out

vcd: aluTest.vcd muxTest.vcd singextensionTest.vcd controlUnitTest.vcd decodeUnitTest.vcd forwardingTest.vcd
